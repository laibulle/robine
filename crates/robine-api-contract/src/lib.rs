...
pub fn openapi_document() -> Value {
    json!({
        ...
        "paths": {
            ...
            "/api/v1/events": { "get": { "security": [{ "bearerAuth": [] }], "parameters": [{ "name": "after", "in": "query", "schema": { "type": "integer", "minimum": 0 } }, { "name": "limit", "in": "query", "schema": { "type": "integer", "minimum": 1, "maximum": 500 } }], "responses": { "200": { "description": "Event replay page" } } } },
