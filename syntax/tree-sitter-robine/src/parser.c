...
enum ts_symbol_identifiers {
  ...
  sym_qualified_identifier = 34,
  sym_boolean = 35,
  sym_string = 36,
  aux_sym_source_file_repeat1 = 37,
  aux_sym_function_declaration_repeat1 = 38,
  aux_sym_effect_row_repeat1 = 39,
  aux_sym_block_repeat1 = 40,
  aux_sym_call_expression_repeat1 = 41,
  aux_sym_qualified_identifier_repeat1 = 42,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 686, lookahead)) ADVANCE(17);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(1);
    ...
    case 17:
      ...
      if (set_contains(sym_identifier_character_set_2, 801, lookahead)) ADVANCE(17);
      END_STATE();
    case 18:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0),
  [26] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  ...
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 0),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 0), SHIFT_REPEAT(91),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualified_identifier, 1, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 7, 0, 17),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 7, 0, 17),
  ...
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 5, 0, 13),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 5, 0, 13),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 1, 0, 0),
  ...
  [89] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  ...
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4, 0, 12),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 3, 0, 9),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(79),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 15),
  ...
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_effect_row_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_effect_row_repeat1, 2, 0, 0),
  ...
  [140] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 16), SHIFT_REPEAT(6),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 16),
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_declaration_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_declaration_repeat1, 2, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 8, 0, 5),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 6),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 7, 0, 3),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 9, 0, 7),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 9, 0, 8),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_declaration, 2, 0, 1),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 10),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 10, 0, 11),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 8, 0, 4),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 14),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 4, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 5, 0, 0),
  ...
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 3, 0, 0),
