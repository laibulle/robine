...
enum ts_symbol_identifiers {
  ...
  aux_sym_function_declaration_repeat1 = 50,
  aux_sym_effect_row_repeat1 = 51,
  aux_sym_block_repeat1 = 52,
  aux_sym_call_expression_repeat1 = 53,
  aux_sym_qualified_identifier_repeat1 = 54,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  ...
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_block, 3, 0, 6),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_block, 3, 0, 6),
  ...
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 10),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 10),
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 3, 0, 11),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 3, 0, 11),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4, 0, 14),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 4, 0, 14),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesized_expression, 3, 0, 9),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesized_expression, 3, 0, 9),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 5, 0, 16),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_expression, 5, 0, 16),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 18),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 5, 0, 18),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 5, 0, 15),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 5, 0, 15),
  ...
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualified_identifier, 2, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 0),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 0), SHIFT_REPEAT(106),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 7, 0, 20),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 7, 0, 20),
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 1, 0, 0),
  ...
  [169] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0),
  [174] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(104),
  ...
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_declaration_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_declaration_repeat1, 2, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [198] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_effect_row_repeat1, 2, 0, 0), SHIFT_REPEAT(91),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_effect_row_repeat1, 2, 0, 0),
  ...
  [213] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19), SHIFT_REPEAT(14),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 6),
  ...
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 7, 0, 3),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 2),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 12),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 10, 0, 13),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 0),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 9, 0, 7),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 9, 0, 8),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 8, 0, 4),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 8, 0, 5),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 3, 0, 0),
  ...
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 4, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_effect_row, 5, 0, 0),
};
